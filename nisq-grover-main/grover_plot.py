'''
This code creates txt file of phi_F to plot. txt file of list of gates is required.
'''
...
f = open('phi_epsilon_'+Target_state+'.txt', 'w')
...
for i in range(1,N_eps):
    ...
    f = open('phi_epsilon_'+Target_state+'.txt', 'a')
